...
class QdrantManager:
    """Manages Qdrant clients and vector stores with support for both sync and async operations."""
    ...
    def get_qdrant_clients(self):
        """Lazy initialization for QdrantClient and AsyncQdrantClient."""
        if self.qdrant_client is None or self.async_qdrant_client is None:
        ...
        return self.qdrant_client, self.async_qdrant_client
    ...
    def get_vector_store(self, dataset: str, hybrid: bool = False):
        ...
        if dataset not in self.vector_stores:
            ...
            client, aclient = self.get_qdrant_clients()
            ...
            self.vector_stores[dataset] = QdrantVectorStore(
                ...
                aclient=aclient,  # Use asynchronous client
                batch_size=20,
                prefer_grpc=True,
